...
def main():
    ...
    # zero_row_tables = []
    # for table in total_rows_count:
    #     if total_rows_count[table] == 0:
    #         zero_row_tables.append(table)
    #
    # print(f'zero_row_tables: {zero_row_tables}')
    #
    #
    # project_ids_to_keep = []
